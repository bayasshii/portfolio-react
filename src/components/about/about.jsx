            ...
            <div className="width">
              <div className="mb-30">
                ...
                <p className="mt-30">
                  ...
                  バレー部に入部する。バレー経験未経験の監督の元、学生たちで練習メニューを考案して改善しながら日々の練習に打ち込む。そして高校３年生の時にビーチバレーでの近畿大会出場を果たす。
                  またこの頃から建築デザインに興味が湧き、１年半ほどの間、毎日美術室に通ってデッサンや設計にチャレンジし始める。
                  <br/>
                  ...
                  卒業製作では、簡単に持ち運びができて安定して座ることのできる、紙でできた椅子を設計する。
                  <br/>
