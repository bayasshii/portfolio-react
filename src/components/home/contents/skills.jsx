...
import display from './image/display.svg';
import keyboard from './image/keyboard.svg';
import home from './image/home.svg';
import boronoi from './image/boronoi.svg';
      ...
      <div className="mySkills">
        ...
        <ul className="flex flex-wrap">
          ...
          <li className="mySkill curiositySkill">
            ...
            <div className="mySkill__image"><img alt="MySkillImage" src={heart} /></div>
            <div className="mySkill__text">好奇心がとても旺盛です。新しい技術や知識に対して幅広い興味があります。</div>
          </li>
        </ul>
      </div>
    );
