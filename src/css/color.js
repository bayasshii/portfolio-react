export const baseText =  "#2F2725"
export const baseText__thin = "#ADA9A9"
...
export const photalGradient = "linear-gradient(0deg, #6babde, #c5dbeb)"
export const photalGradientNaname = "linear-gradient(25deg, #6babde, #c5dbeb)"
